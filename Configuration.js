...
function getEndpoints(deviceAddress, endpoints)
{
    ...
    var alarm = endpoints.addEndpoint("1", "Water leak alarm", endpointType.genericSensor);
        alarm.variableTypeId = 1205;

    var duration = endpoints.addEndpoint("2", "Last water leak duration", endpointType.genericSensor);
        duration.variableTypeId = 1204;

    var leak = endpoints.addEndpoint("3", "Water leak status", endpointType.genericSensor);
        leak.variableTypeId = 1203;
